    ...
    <div className="bg-slate-55 min-h-screen pb-24 font-jakarta overflow-x-hidden">
      ...
      <section className="relative py-28 sm:py-36 overflow-hidden border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 text-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-blue-950 tracking-tight leading-none max-w-4xl mx-auto">
            PKIMSE Campus Media
          </h1>
          <p className="text-slate-600 text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed font-medium">
            Take a look inside our simulation labs, heavy marine workshop, residential hostel block, and cadet training activities.
          </p>
        </div>
      </section>

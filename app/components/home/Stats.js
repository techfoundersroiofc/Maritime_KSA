...
function StatCard({ stat }) {
  ...
  return (
    <div
      className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xs flex flex-col justify-between text-center transition-all duration-300 hover:border-orange-500/30 hover:bg-white/8 hover:shadow-2xl hover:shadow-orange-500/5 group hover:-translate-y-1.5 select-none"
    ...
    >
      ...
      <p className="text-[10px] sm:text-xs text-slate-400 leading-normal border-t border-white/5 pt-2.5 mt-2">
        {stat.subLabel}
      </p>
    </div>
  );
...
export default function Stats() {
  return (
    <section className="relative bg-linear-to-br from-blue-950 via-slate-900 to-blue-950 py-20 border-y border-blue-900/40 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-size-[3rem_3rem] mask-[radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-80" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="inline-flex items-center space-x-1.5 bg-orange-500/15 border border-orange-500/25 rounded-full px-3 py-1 mb-4">
            ...
            <span className="text-[10px] font-extrabold text-orange-400 tracking-widest uppercase">

...
export default function FeaturedCourses() {
  ...
  return (
    <section className="bg-slate-50 py-20 sm:py-28 border-t border-slate-200/70 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 w-full">
        ...
        >
          ...
          <Link
            href="/courses"
            className="group text-orange-600 hover:text-orange-700 font-extrabold text-sm flex items-center transition-colors select-none shrink-0 self-start sm:self-end bg-orange-50 hover:bg-orange-100/50 px-4 py-2.5 rounded-lg border border-orange-200/40"
          >
              ...
              >
                ...
                <div className="relative h-56 sm:h-64 md:h-72 w-full overflow-hidden bg-slate-100">
                  ...
                  {meta.statusBadge.text && (
                    <div className="absolute top-5 right-5 bg-emerald-500 text-white text-[10px] font-black uppercase tracking-widest px-3.5 py-2 rounded-lg flex items-center space-x-1.5 shadow-md">
                  ...
                  {/* Duration Overlay */}
                  <div className="absolute bottom-5 left-5 flex items-center space-x-2 bg-white text-blue-950 text-xs font-black px-4 py-2 rounded-xl shadow-md border border-slate-100">
                ...
                <div className="p-6 sm:p-8 md:p-9 grow flex flex-col justify-between text-left">
                  <div>
                    <h3 className="text-blue-950 font-black text-xl sm:text-2xl group-hover:text-orange-600 transition-colors mb-4.5 leading-snug">
                      {course.title}
                    </h3>

    ...
    <section className="bg-slate-950 py-24 border-t border-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gsap-slide-up">
          ...
          <Link
            href="/courses"
            className="group text-orange-500 hover:text-orange-400 font-bold text-xs flex items-center transition-colors mt-4 md:mt-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 gsap-stagger-container">
          {featured.map((course) => (
            <div
              key={course.id}
              className="bg-slate-900/40 border border-slate-900 rounded-lg overflow-hidden flex flex-col justify-between group hover:border-orange-500/20 hover:bg-slate-900/60 transition-all duration-300 shadow-2xl hover:-translate-y-1 gsap-stagger-item"
            >
              {/* Course Image */}
              <div className="relative h-56 w-full overflow-hidden bg-slate-950">
                ...
                <div className="absolute top-4 left-4 bg-orange-650 text-white text-[9px] font-bold uppercase tracking-widest px-2.5 py-1 rounded">
                  {course.type}
                </div>
              </div>
              ...
              <div className="p-6 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-white font-bold text-lg group-hover:text-orange-500 transition-colors mb-3 leading-snug">
                    {course.title}
                  </h3>
                  ...
                  <div className="border-t border-slate-900 pt-4 mt-2">
                    <h4 className="text-[10px] font-bold text-slate-300 uppercase tracking-wider mb-2 flex items-center">
                      <GraduationCap className="w-4 h-4 text-orange-500 mr-1.5" />

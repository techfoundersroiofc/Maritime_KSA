      ...
      info: (
        <div className="space-y-1">
          <p className="text-slate-655 hover:text-blue-950 transition-colors">
            Phone:{" "}
            <a href={`tel:${COLLEGE_CONFIG.phone}`} className="font-bold">
      ...
      info: (
        <div className="space-y-1">
          <p className="text-slate-655 hover:text-blue-950 transition-colors break-all">
            Primary:{" "}
            <a href={`mailto:${COLLEGE_CONFIG.email}`} className="font-bold">
      ...
      <div className="space-y-4">
        {details.map((det, index) => {
          ...
          return (
            ...
            >
              <div
                className={`w-10 h-10 rounded-xl border flex items-center justify-center shrink-0 ${det.color} group-hover:scale-105 transition-transform duration-300`}
              >
              ...
              <div className="space-y-1 flex-1">
                ...
                {typeof det.info === "string" ? (
                  ...
                  <div className="text-xs sm:text-sm text-slate-655 font-medium">
                    {det.info}
                  </div>
                )}
              </div>

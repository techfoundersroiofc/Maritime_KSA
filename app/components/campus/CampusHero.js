  ...
  return (
    <section className="relative py-28 sm:py-36 overflow-hidden border-b border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 text-center space-y-6">
        ...
        >
          PKIMSE operates a state-of-the-art residential campus at Chidambaram, Tamil Nadu. Experience a simulated naval setting equipped with modern simulators, heavy machinery workshop, and premium recreational amenities.
        </motion.p>
      </div>
    </section>
  );
